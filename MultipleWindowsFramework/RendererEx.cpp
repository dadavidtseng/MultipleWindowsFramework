...
HRESULT RendererEx::Initialize(HWND const& hiddenMainWindow)
{
    ...
    hr = CreateTestTexture(L"C:/Github/MultipleWindowsFramework/Run/Data/Images/Butler.png");
    if (FAILED(hr)) return hr;
...
void RendererEx::SetWindowDriftParams(HWND const hwnd, const sDriftParams& params)
{
